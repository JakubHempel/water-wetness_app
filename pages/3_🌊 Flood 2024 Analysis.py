...
st.set_page_config(layout="wide", page_title="🌊 Flood 2024 Analysis | HydroPix 💧🛰️")
...
st.subheader("🌊 Flood 2024 Analysis")

tab1, tab2, tab3, tab4 = st.tabs(["🛰️📡 Sentinel-1", "🛰️📷 Sentinel-2", "🌍 Spectral Indices - Water Quality", "💦 Water Masks"])
...
with tab1:
    ...
    selected_layers_s1 = st.pills(
        "Choose Sentinel-1 layers to display:",
